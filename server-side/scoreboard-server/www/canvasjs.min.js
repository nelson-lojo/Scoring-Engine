...
(function() {
  ...
  function fb(k) {
      if (k._menuButton) k.exportEnabled ?
          La(k._menuButton) : ua(k._menuButton);
  ...
  function Ma(k, l, v) {
      if (t && Za) {
          ...
          k.width = l * ja;
          k.height = v * ja;
          Qa !== Na && (k.style.width = l + "px", k.style.height = v + "px", s.scale(ja, ja))
  ...
  var Ga = !1,
      ...
      Ea = t ? "Impact, Charcoal, sans-serif" :
      "Arial",
      za = {
              ...
              if (l = M.pop(), "#" === l || "0" === l)
                  if (P++, P === R) {
                      var X = D,
                          D = [];
                      if ("0" === l)
                          for (l = R - I - (X ? X.length : 0); 0 < l;) X.unshift("0"), l--;
                      for (; 0 < X.length;) v = X.pop() + v, S++, 0 === S % E && (N === V && 0 < X.length) && (v = w + v)
                  } else 0 < D.length ? (v = D.pop() + v, I++, S++) : "0" === l && (v = "0" + v, I++, S++), 0 === S %
                      E && (N === V && 0 < D.length) && (v = w + v);
          else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (N++, E = S, S = 0, 0 < D.length && (v = w + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) {
              return $(W, a.length)
          }));
          w = "";
          for (M = !1; 0 < G.length;) l = G.shift(), "#" === l || "0" === l ? 0 < k.length && 0 !== Number(k.join("")) ? (w += k.shift(), M = !0) : "0" === l && (w += "0", M = !0) : 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? w += l.slice(1, l.length - 1) : "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? w += l : (l = 0 > W ? l.replace("+", "").replace("-", "") : l.replace("-", ""), w += l.replace(/[0]+/, function(a) {
              return $(W, a.length)
          }));
          v += (M ? t : "") + w;
          return s ? "-" + v : v
  ...
  W.prototype.set = function(k, l, s) {
      ...
      else if (t.hasOwnProperty(k) || t.publicProperties && t.publicProperties.hasOwnProperty(k) && "readWrite" === t.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(), this.options[k] = l;
      else {
  ...
  "undefined" !== typeof module &&
      "undefined" !== typeof module.exports ? module.exports = Ka : "function" === typeof define && define.amd ? define([], function() {
          return Ka
      }) : window.CanvasJS = Ka;
  Ka.Chart = function() {
      function k(a, d) {
          ...
          (this.container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 =
              ...
              this.canvas = ta(a, d), this._preRenderCanvas = ta(a, d), this.canvas.style.position = "absolute", this.canvas.style.WebkitUserSelect = "none", this.canvas.style.MozUserSelect = "none", this.canvas.style.msUserSelect = "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Ba(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Ba(this._preRenderCtx),
                  ...
                  V(this.overlaidCanvas, "mousedown", function(a) {
                      ...
                      b._mouseEventHandler(a)
                  }, this.allDOMEventHandlers), V(this.overlaidCanvas, window.navigator.msPointerEnabled ? "MSPointerDown" : "touchstart", function(a) {
      ...
      function v(a, d) {
          for (var c = [], b, e = 0; e < a.length; e++)
              if (0 == e) c.push(a[0]);
                  ...
                  f = 0 === m ? 0 : m - 1;
                  n = m === a.length - 1 ? m : m + 1;
                  b = Math.abs((a[n].x - a[f].x) / (0 === a[m].x - a[f].x ? 0.01 : a[m].x - a[f].x)) * (d -
                      1) / 2 + 1;
                  A = (a[n].x - a[f].x) / b;
                  b = (a[n].y - a[f].y) / b;
                  c[c.length] = a[m].x > a[f].x && 0 < A || a[m].x < a[f].x && 0 > A ? {
      ...
      function w(a, d, c, b, e, f, n, m, A, g) {
          ...
          a.beginPath();
          A && 0 < n.thickness ? (a.moveTo(b - r, c), a.lineTo(b -
              r, e), a.moveTo(d + r, c), a.lineTo(d + r, e)) : 0 < n.thickness && (a.moveTo(d, c + r), a.lineTo(b, c + r), a.moveTo(d, e - r), a.lineTo(b, e - r));
          a.stroke();
          a.restore()
      }
      ...
      function D(a, d, c, b, e, f) {
          ...
          this.isOptionsInArray = !0;
          "axisX" === e ? ("left" === f || "bottom" === f ? (this.optionsName = "axisX", s(this.chart.sessionVariables.axisX[b]) && (this.chart.sessionVariables.axisX[b] = {}), this.sessionVariables = this.chart.sessionVariables.axisX[b]) :
          ...
          this.labelAngle = (this.labelAngle %
              360 + 360) % 360;
          ...
          if (this.options.stripLines && 0 < this.options.stripLines.length)
              for (a = 0; a < this.options.stripLines.length; a++) this.stripLines.push(new M(this.chart, this.options.stripLines[a], a, ++this.chart._eventManager.lastObjectId,
                  this));
      ...
      function T(a, d, c, b) {
          ...
          "string" === typeof this.spacing ?
              (this.spacing = parseFloat(this.spacing), this.spacing = isNaN(this.spacing) ? 8 : (10 < this.spacing ? 10 : this.spacing) + "%") : "number" !== typeof this.spacing && (this.spacing = 8);
          this.autoCalculate && (this.maxNumberOfAutoBreaks = Math.min(this.maxNumberOfAutoBreaks, 5));
          if (this.options.customBreaks && 0 < this.options.customBreaks.length) {
              for (a = 0; a < this.options.customBreaks.length; a++) this.customBreaks.push(new U(this.chart, "customBreaks", this.options.customBreaks[a], a, ++this.chart._eventManager.lastObjectId, this)), "number" ===
                  typeof this.customBreaks[a].startValue && ("number" === typeof this.customBreaks[a].endValue && this.customBreaks[a].endValue !== this.customBreaks[a].startValue) && this._appliedBreaks.push(this.customBreaks[a]);
              this._appliedBreaks.sort(function(a, b) {
                  return a.startValue - b.startValue
              });
              for (a = 0; a < this._appliedBreaks.length - 1; a++) this._appliedBreaks[a].endValue >= this._appliedBreaks[a + 1].startValue && (this._appliedBreaks[a].endValue = Math.max(this._appliedBreaks[a].endValue, this._appliedBreaks[a + 1].endValue), window.console &&
                  window.console.log("CanvasJS Error: Breaks " + a + " and " + (a + 1) + " are overlapping."), this._appliedBreaks.splice(a, 2), a--)
          }
      }
      ...
      function U(a, d, c, b, e, f) {
          ...
          this.spacing = "undefined" === typeof c.spacing ?
              f.spacing : c.spacing;
      ...
      l.prototype.destroy = function() {
          ...
          for (; this._dropdownMenu &&
              this._dropdownMenu.hasChildNodes();) this._dropdownMenu.removeChild(this._dropdownMenu.lastChild);
      ...
      l.prototype._updateOptions = function() {
          ...
          if (this.options.zoomEnabled || this.panEnabled) {
              ...
              this._resetButton || (d = !1, ua(this._resetButton = document.createElement("button")), va(this, this._resetButton,
                  "reset"), this._resetButton.style.borderRight = (this.exportEnabled ? this.toolbar.borderThickness : 0) + "px solid " + this.toolbar.borderColor, this._toolBar.appendChild(this._resetButton), V(this._resetButton, "touchstart", function(a) {
                  d = !0
      ...
      l.prototype.renderElements = function() {
          ...
          if (0 < c.length) r.disableToolTip = !0, r._animator.animate(200, r.animationDuration, function(a) {
              ...
              for (var a = 0; a < r.plotInfo.plotTypes.length; a++)
                  for (var e = r.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) e.plotUnits[d].targetCanvas = null;
              b = null;
              r.disableToolTip = !1;
              ...
              if (r._breaksCanvas)
                  if (t) r.plotArea.ctx.drawImage(r._breaksCanvas, 0, 0, this.width, this.height);
                  else
                      for (g = 0; g < r._axes.length; g++) r._axes[g].createMask();
      ...
      l.prototype.categoriseDataSeries = function() {
          for (var a = "", d = 0; d < this.data.length; d++)
              ...
              for (c = this.plotInfo.plotTypes[d], n = a = 0; n < c.plotUnits.length; n++) c.plotUnits[n].previousDataSeriesCount =
      ...
      l.prototype._processStackedPlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = [], m = [], A = Infinity, g = -Infinity, r = 0; r < a.dataSeriesIndexes.length; r++) {
                  var q =
                      this.data[a.dataSeriesIndexes[r]],
                      p = 0,
                      h = !1,
                      C = !1,
                      k;
                  ...
                  for (p = 0; p < q.dataPoints.length; p++) {
                      ...
                      if (b < aa && !h) null !== q.dataPoints[p].y && (k = b);
                      else {
                          if (!h && (h = !0, 0 < p)) {
                              p -= 2;
                              continue
                          ...
                          b < c.viewPortMin && (c.viewPortMin = b);
                          b > c.viewPortMax && (c.viewPortMax = b);
                          null === q.dataPoints[p].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? n[b] ? n[b] += e : (n[b] = e, A = Math.min(e, A)) : m[b] ? m[b] += e : (m[b] = e, g = Math.max(e, g)))
                      }
                  }
              ...
              for (p in m) m.hasOwnProperty(p) && !isNaN(p) && (a = m[p], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, g)), p < c.viewPortMin ||
                  p > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, g))))
          }
      };
      l.prototype._processStacked100PlotUnit = function(a) {
          if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
              for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = !1, m = !1, A = [], g = 0; g < a.dataSeriesIndexes.length; g++) {
                  var r = this.data[a.dataSeriesIndexes[g]],
                      q = 0,
                      p = !1,
                      h = !1,
                      C;
          ...
          function(a) {
              if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                  for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, n = 0; n < a.dataSeriesIndexes.length; n++) {
                      ...
                      for (A = 0; A < m.dataPoints.length; A++)
                          if ("undefined" === typeof m.dataPoints[A].x && (m.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), m.dataPoints[A].x.getTime ? (f = !0, b = m.dataPoints[A].x.getTime()) : b = m.dataPoints[A].x, e = m.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), m.dataPointEOs[A].cumulativeSum <
                              d.min && (d.min = m.dataPointEOs[A].cumulativeSum), m.dataPointEOs[A].cumulativeSum > d.max && (d.max = m.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (q = b / m.dataPoints[A - 1].x, 1 > q && (q = 1 / q), c.minDiff > q && 1 !== q && (c.minDiff = q)) : (q = b - m.dataPoints[A - 1].x, 0 > q && (q *= -1), c.minDiff > q && 0 !== q && (c.minDiff = q)), null !== e && null !== m.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = m.dataPointEOs[A].cumulativeSum / m.dataPointEOs[A - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = m.dataPointEOs[A].cumulativeSum -
                                  m.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < p) || g) {
                              if (!g && (g = !0, 0 < A)) {
                                  A -= 2;
                                  continue
                              }
                      ...
                      for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, h, g = f.min, n = f.max, m = d.min, r = d.max, f = f._dataRanges, d = d._dataRanges, p, q = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                          ...
                          if (!(4 > k.dataPoints.length))
                              for (q = 0; q < k.dataPoints.length; q++)
                                  if (b && (p = (n + 1 - g) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, h = k.dataPoints[q].x.getTime ? k.dataPoints[q].x.getTime() : k.dataPoints[q].x, p = Math.floor((h - g) / p), h < f[p].min && (f[p].min = h), h > f[p].max && (f[p].max = h)), c) {
                                      ...
                                      if ((h = "waterfall" === a.type ? k.dataPointEOs[q].cumulativeSum : k.dataPoints[q].y) && h.length)
                                          for (var t = 0; t < h.length; t++) p =
                                              Math.floor((h[t] - m) / l), h[t] < d[p].min && (d[p].min = h[t]), h[t] > d[p].max && (d[p].max = h[t]);
                                      else s(h) || (p = Math.floor((h - m) / l), h < d[p].min && (d[p].min = h), h > d[p].max && (d[p].max = h))
                                  }
                      }
              }
          }
              ...
              if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                  for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, h, g = 0, n = 0; n < a.dataSeriesIndexes.length; n++) {
                      ...
                      if (!(4 > m.dataPoints.length))
                          for (g =
                              0; g < m.dataPoints.length; g++) h = (d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, b = m.dataPoints[g].x.getTime ? m.dataPoints[g].x.getTime() : m.dataPoints[g].x, h = Math.floor((b - c) / h), b < f[h].min && (f[h].min = b), b > f[h].max && (f[h].max = b)
                  }
          }
          for (var b, e = this, f = !1, n = 0; n < this._axes.length; n++)
              if (this._axes[n].scaleBreaks && this._axes[n].scaleBreaks.autoCalculate && 1 <= this._axes[n].scaleBreaks.maxNumberOfAutoBreaks) {
                  ...
                  for (var m = 0; m < 100 / Math.max(parseFloat(this._axes[n].scaleBreaks.collapsibleThreshold) ||
                          10, 10); m++) this._axes[n].dataInfo._dataRanges.push({
                      min: Infinity,
                      max: -Infinity
                  })
              } if (f) {
              for (n = 0; n < this.plotInfo.plotTypes.length; n++)
                  for (f = this.plotInfo.plotTypes[n], m = 0; m < f.plotUnits.length; m++) b = f.plotUnits[m], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" ===
              ...
              for (n = 0; n < this._axes.length; n++)
                  if (this._axes[n].dataInfo._dataRanges) {
                      ...
                      var g = this._axes[n].dataInfo._dataRanges,
                          r, q, f = [];
                      ...
                      for (m = 0; m < g.length -
                          1; m++)
                          if (r = g[m].max, isFinite(r))
                              for (; m < g.length - 1;)
                                  if (A = g[m + 1].min, isFinite(A)) {
                                      q = A - r;
                                      q > b && f.push({
                                          diff: q,
                                          start: r,
                      ...
                      if (this._axes[n].scaleBreaks.customBreaks)
                          for (m = 0; m < this._axes[n].scaleBreaks.customBreaks.length; m++)
                              for (b = 0; b < f.length; b++)
                                  if (this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue || this._axes[n].scaleBreaks.customBreaks[m].startValue <= f[b].start && f[b].start <= this._axes[n].scaleBreaks.customBreaks[m].endValue ||
      ...
      l.prototype.getObjectAtXY = function(a, d, c) {
          ...
          else if (t) b = Ya(a, d, this._eventManager.ghostCtx);
          else
              ...
              if (!(c && 1 < c.length)) {
                  ...
                  if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1;
                      ...
                      for (c = 0; c < d.length; c++)
                          if (e = d[c], n = document.createEvent("MouseEvent"), n.initMouseEvent(e, !0, !0, window,
      ...
      l.prototype._plotAreaMouseUp = function(a, d) {
          ...
          if ("none" !== this.plotInfo.axisPlacement) {
              ...
              if (this.axisX && 0 < this.axisX.length)
                  for (n = 0; n < this.axisX.length; n++) this.axisX[n].crosshair && this.axisX[n].crosshair.enabled && this.axisX[n].renderCrosshair(a, d);
              if (this.axisX2 && 0 < this.axisX2.length)
                  for (n = 0; n < this.axisX2.length; n++) this.axisX2[n].crosshair && this.axisX2[n].crosshair.enabled && this.axisX2[n].renderCrosshair(a, d);
              if (this.axisY && 0 < this.axisY.length)
                  for (n = 0; n < this.axisY.length; n++) this.axisY[n].crosshair && this.axisY[n].crosshair.enabled &&
                      this.axisY[n].renderCrosshair(a, d);
              if (this.axisY2 && 0 < this.axisY2.length)
                  for (n = 0; n < this.axisY2.length; n++) this.axisY2[n].crosshair && this.axisY2[n].crosshair.enabled && this.axisY2[n].renderCrosshair(a, d)
          }
      };
      ...
      l.prototype.validateRegion = function(a, d, c, b, e) {
          ...
          for (n = 0; n < g.length; n++) {
              ...
              if (p > h) var C = h,
                  ...
                  p = C;
              if (q.scaleBreaks)
                  for (C = 0; !f && C < q.scaleBreaks._appliedBreaks.length; C++) f =
                      q.scaleBreaks._appliedBreaks[C].startValue <= p && q.scaleBreaks._appliedBreaks[C].endValue >= h;
              if (isFinite(q.dataInfo.minDiff))
                  if (C = q.getApparentDifference(p, h, null, !0), !(f || !(this.panEnabled && q.scaleBreaks && q.scaleBreaks._appliedBreaks.length) && (q.logarithmic && C < Math.pow(q.dataInfo.minDiff, 3) || !q.logarithmic && C < 3 * Math.abs(q.dataInfo.minDiff)) || p < q.minimum || h > q.maximum)) A.push(q), r.push({
                      val1: p,
                      val2: h
                  }), m = !0;
                  else if (!e) {
      ...
      l.prototype.renderIndexLabels = function(a) {
          ...
          for (a = 0; a < this._indexLabels.length; a++) {
              var g = this._indexLabels[a],
                  r = g.chartType.toLowerCase(),
                  q, p, m = ma("indexLabelFontColor", g.dataPoint, g.dataSeries),
              ...
              var n = ma("indexLabelFontWeight", g.dataPoint, g.dataSeries),
                  ...
                  l = s(g.dataPoint.indexLabelLineThickness) ? s(g.dataSeries.options.indexLabelLineThickness) ? 0 : g.dataSeries.options.indexLabelLineThickness :
                  g.dataPoint.indexLabelLineThickness,
              ...
              if (g.dataSeries.indexLabelFormatter || g.dataPoint.indexLabelFormatter) x = {
                  chart: this,
              ...
              if (null !== z && "" !== z) {
                  ...
                  if ("stackedarea100" === r) {
                      ...
                      if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || g.dataPoint.y < B.viewportMinimum || g.dataPoint.y > B.viewportMaximum) continue
                  } else if (0 <= r.indexOf("column") || "waterfall" === r ||
                      "error" === r && !g.axisSwapped) {
                      ...
                      if (g.dataPoint.x < y.viewportMinimum || g.dataPoint.x > y.viewportMaximum || Math.max.apply(null, g.dataPoint.y) < B.viewportMinimum || Math.min.apply(null, g.dataPoint.y) > B.viewportMaximum) continue
                  } else if (g.dataPoint.x <
                      y.viewportMinimum || g.dataPoint.x > y.viewportMaximum) continue;
                  e = n = 2;
                  "horizontal" === x ? (m = h.width, A = h.height) : (A = h.width, m = h.height);
                  if ("normal" === this.plotInfo.axisPlacement) {
                      if (0 <= r.indexOf("line") || 0 <= r.indexOf("area")) u = "auto", n = 4;
                      else if (0 <= r.indexOf("stacked")) "auto" === u && (u = "inside");
                      else if ("bubble" === r || "scatter" === r) u = "inside";
                      q = g.point.x - m / 2;
                      "inside" !== u ? (e = c.y1, f = c.y2, 0 < J ? (p = g.point.y - A - n - b, p < e && (p = "auto" === u ? Math.max(g.point.y, e) + n + b : e + n + b, v = p + A > g.point.y)) : (p = g.point.y + n + b, p > f - A - n - b && (p =
                      ...
                      c.x1) + m / 2 + e : Math.min(g.bounds.x2, c.x2) - m / 2 - e : (Math.max(g.bounds.x1, c.x1) + Math.min(g.bounds.x2, c.x2)) / 2, q = 0 > J ? Math.max(g.point.x, b) - m / 2 : Math.min(g.point.x, b) - m / 2, q = Math.max(q, n));
                  "vertical" === x && (p += A);
                  h.x = q;
                  h.y = p;
                  h.render(!0);
                  l && ("inside" !== u && (0 > r.indexOf("bar") && ("error" !== r || !g.axisSwapped) && g.point.x > c.x1 && g.point.x < c.x2 || !v) && (0 > r.indexOf("column") && ("error" !== r || g.axisSwapped) && g.point.y > c.y1 && g.point.y < c.y2 || !v)) && (d.lineWidth = l, d.strokeStyle = k ? k : "gray", d.setLineDash && d.setLineDash(P(C, l)),
                      d.beginPath(), d.moveTo(g.point.x, g.point.y), 0 <= r.indexOf("bar") || "error" === r && g.axisSwapped ? d.lineTo(q + (0 < g.direction ? 0 : m), p + ("horizontal" === x ? A : -A) / 2) : 0 <= r.indexOf("column") || "error" === r && !g.axisSwapped ? d.lineTo(q + m / 2, p + ((0 < g.direction ? A : -A) + ("horizontal" === x ? A : -A)) / 2) : d.lineTo(q + m / 2, p + ((p < g.point.y ? A : -A) + ("horizontal" === x ? A : -A)) / 2), d.stroke())
              }
          }
          d = {
              source: d,
          ...
          for (a = 0; a <
              this._indexLabels.length; a++) g = this._indexLabels[a], h = ma("indexLabelBackgroundColor", g.dataPoint, g.dataSeries), g.dataSeries.indexLabelBackgroundColor = s(h) ? t ? "transparent" : null : h;
          return d
      };
              ...
              for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if (0 < r.length) {
                      for (var J = !1, u = 0; u < r.length; u++)
                          if (x = r[u].x.getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J)))
                              if ("number" !== typeof r[u].y) 0 < u && !(g.connectNullData || J || l) && (c.stroke(), t && b.stroke()), J = !0;
                              else {
                                  ...
                                  l || J ? (!l && g.connectNullData ?
                                      (c.setLineDash && (g.options.nullDataLineDashType || q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(n.x, n.y), q = g.nullDataLineDashType, c.setLineDash(p)), c.lineTo(x, s), t && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), t && (b.beginPath(), b.moveTo(x, s))), J = l = !1) : (c.lineTo(x, s), t && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), t && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                  n = {
                                      x: x,
                                      y: s
                                  };
                                  u < r.length - 1 && (k !== (r[u].lineColor || C) || q !== (r[u].lineDashType ||
                                      g.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), k = r[u].lineColor || C, c.strokeStyle = k, c.setLineDash && (r[u].lineDashType ? (q = r[u].lineDashType, c.setLineDash(P(q, g.lineThickness))) : (q = g.lineDashType, c.setLineDash(h))));
                                  ...
                                  }(r[u].indexLabel || g.indexLabel || r[u].indexLabelFormatter || g.indexLabelFormatter) &&
      ...
      l.prototype.renderStepLine = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var f = [], n, m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  b.lineWidth = 0 < g.lineThickness ? Math.max(g.lineThickness, 4) : 0;
                  var C = g._colorSet,
                      k = C = g.lineColor = g.options.lineColor ? g.options.lineColor :
                      C[0];
                  c.strokeStyle = C;
                  var l = !0,
                      u = 0,
                  ...
                  if (0 < r.length) {
                      for (var J = !1, u = 0; u < r.length; u++)
                          if (x = r[u].getTime ? r[u].x.getTime() : r[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !J)))
                              if ("number" !== typeof r[u].y) 0 < u && !(g.connectNullData || J || l) && (c.stroke(), t && b.stroke()), J = !0;
                              else {
                                  var y = s;
                                  x = a.axisX.convertValueToPixel(x);
                  ...
                  if (0 < r.length)
                      for (s = !1, l = 0; l < r.length; l++)
                          if (u = r[l].getTime ? r[l].x.getTime() : r[l].x,
                              ...
                              if ("number" !== typeof r[l].y) 0 < l && !s && (g.connectNullData ? b.setLineDash && (0 < z.length && (g.options.nullDataLineDashType || !r[l - 1].lineDashType)) && (z[z.length - 1].newLineDashArray = p, q = g.nullDataLineDashType) : (d(z), z = [])), s = !0;
                              else {
                                  ...
                                  l < r.length - 1 && (k !== (r[l].lineColor || C) || q !== (r[l].lineDashType || g.lineDashType)) && (k = r[l].lineColor || C, z[z.length - 1].newStrokeStyle = k, b.setLineDash && (r[l].lineDashType ? (q = r[l].lineDashType, z[z.length - 1].newLineDashArray = P(q, g.lineThickness)) : (q = g.lineDashType, z[z.length - 1].newLineDashArray = h)));
                                  if (0 < r[l].markerSize || 0 < g.markerSize) {
                                      ...
                                      g.indexLabel || r[l].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({
                                      chartType: "spline",
                                      dataPoint: r[l],
                                      dataSeries: g,
                                      point: {
      ...
      l.prototype.renderColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null,
                  e = this.plotArea,
                  f = 0,
                  n, m, A, g = a.axisY.convertValueToPixel(a.axisY.logarithmic ?
                  ...
                  if (0 < C.length)
                      for (var k = 5 < q && h.bevelEnabled ? !0 : !1, f = 0; f < C.length; f++)
                          if (C[f].getTime ? A = C[f].x.getTime() : A = C[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof C[f].y) {
                              ...
                              (C[f].indexLabel ||
                                  h.indexLabel || C[f].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({
                                  chartType: "column",
                                  dataPoint: C[f],
                                  dataSeries: h,
                                  point: {
      ...
      l.prototype.renderStackedColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null,
                  ...
                  A = [],
                  g = 0,
                  r, q, p = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
              ...
              for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                  ...
                  if (0 < u.length) {
                      ...
                      for (g = 0; g < u.length; g++)
                          if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                              "number" === typeof u[g].y) {
                              r = a.axisX.convertValueToPixel(b);
                              var z = r - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                  J = z + h << 0,
                                  y;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (q = a.axisY.convertValueToPixel(m[b]), y = "undefined" !== typeof f[b] ? f[b] : p, f[b] = q);
                              else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), y = a.axisY.convertValueToPixel(A[b]), q = "undefined" !== typeof n[b] ?
                                  n[b] : p, n[b] = y;
                              else if (q = a.axisY.convertValueToPixel(u[g].y), 0 <= u[g].y) {
                              ...
                              b = R(b);
                              t && da(this._eventManager.ghostCtx, z, q, J, y, b, 0, null, !1,
                                  !1, !1, !1);
              ...
              for (var C = 0; C < a.dataSeriesIndexes.length; C++) {
                  ...
                  if (0 < u.length)
                      for (var s = 5 < h && l.bevelEnabled ? !0 : !1, g = 0; g < u.length; g++)
                          if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                              r =
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
                                  ...
                                  y = f[b] ? f[b] : p;
                                  f[b] = q
                              } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = q + ("undefined" !== typeof A[b] ? A[b] : 0),
                                  y = a.axisY.convertValueToPixel(A[b]), q = n[b] ? n[b] : p, n[b] = y;
                              else if (q = a.axisY.convertValueToPixel(q), 0 <= u[g].y) {
                                  var B = "undefined" !== typeof f[b] ? f[b] : 0;
                                  q -= B;
                                  y = p - B;
      ...
      l.prototype.renderBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null,
                  e = this.plotArea,
                  f = 0,
                  n, m, A, g = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                  f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
      ...
      l.prototype.renderStackedBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              this.dataPointMaxWidth && g > q && (g = Math.min(this.options.dataPointWidth ?
                  ...
                  if (0 < u.length) {
                      ...
                      for (g = 0; g < u.length; g++)
                          if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                              ...
                              var z = q - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                  J = z + h << 0,
                                  y;
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) m[b] = u[g].y + (m[b] ? m[b] : 0), 0 < m[b] && (y = f[b] ? f[b] :
                                  p, f[b] = r = a.axisY.convertValueToPixel(m[b]));
                              else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = u[g].y + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = y = a.axisY.convertValueToPixel(A[b]);
                              else if (r = a.axisY.convertValueToPixel(u[g].y), 0 <= u[g].y) {
                                  var B = f[b] ? f[b] : 0;
                                  y = p + B;
                                  r += B;
                                  f[b] = B + (r - y)
      ...
      l.prototype.renderStackedBar100 = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              !this.dataPointMaxWidth && (this.dataPointMinWidth &&
                  q < g) && (q = Math.max(this.options.dataPointWidth ? this.dataPointWidth : -Infinity, g));
              h < g && (h = g);
              h > q && (h = q);
              c.save();
              t && this._eventManager.ghostCtx.save();
                      ...
                      for (g = 0; g < u.length; g++)
                          if (b = u[g].x.getTime ? u[g].x.getTime() : u[g].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[g].y) {
                              ...
                              if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[g].y) {
                                  ...
                                  0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[g].y) A[b] = z + (A[b] ? A[b] : 0), r = n[b] ? n[b] : p, n[b] = z = a.axisY.convertValueToPixel(A[b]);
                              else if (r = a.axisY.convertValueToPixel(z), 0 <= u[g].y) {
                                  var B = f[b] ? f[b] : 0;
                                  z = p + B;
                                  r += B;
      ...
      l.prototype.renderArea = function(a) {
          ...
          function b() {
              y && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z), f.lineTo(l, J), f.lineTo(y.x, J), f.closePath(), f.globalAlpha = h.fillOpacity, f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(),
                  n.fill()), f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {
                  x: l,
                  y: u
              })
          }
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  d = !0;
                  var k = 0,
                      l, u, s, z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                      J, y = null;
                  if (0 < C.length) {
                      ...
                      for (var ha = !0; k < C.length; k++)
                          if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ha)))
                              if ("number" !== typeof C[k].y) h.connectNullData || (ha || d) || b(), ha = !0;
                              else {
                                  l = a.axisX.convertValueToPixel(s);
                                  u = a.axisY.convertValueToPixel(C[k].y);
                                  d || ha ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = r.x, u = r.y, b(), f.moveTo(r.x,
                                      r.y), l = d, u = c, y = r, c = h.nullDataLineDashType, f.setLineDash(L)), f.lineTo(l, u), t && n.lineTo(l, u)) : (f.beginPath(), f.moveTo(l, u), t && (n.beginPath(), n.moveTo(l, u)), y = {
                                      x: l,
                                      y: u
                                  ...
                                  0 !== C[k].markerSize && (0 < C[k].markerSize || 0 < h.markerSize) && (s = h.getMarkerProperties(k, l, u, f), A.push(s), Z = R(Z), t && A.push({
                                      x: l,
                                      y: u,
                                      ctx: n,
                                      type: s.type,
      ...
      l.prototype.renderSplineArea = function(a) {
              ...
              if (0 < c.length) {
                  if (0 < r.lineThickness) {
                      ...
                      for (var d = 0; d < c.length - 3; d += 3)
                          if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), t &&
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                  ...
                  var n = [],
                      p = 0,
                      h, C, k = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum :
                          0),
                      l, u = null,
                      s = [];
                  if (0 < q.length) {
                      ...
                      for (C = !1; p < q.length; p++)
                          if (h = q[p].x.getTime ? q[p].x.getTime() : q[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !C)))
                              if ("number" !== typeof q[p].y) 0 < p &&
                                  !C && (r.connectNullData ? b.setLineDash && (0 < s.length && (r.options.nullDataLineDashType || !q[p - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = w, B = r.nullDataLineDashType) : (d(), s = [])), C = !0;
                              else {
                                  ...
                                  p < q.length - 1 && (y !== (q[p].lineColor || J) || B !== (q[p].lineDashType || r.lineDashType)) && (y = q[p].lineColor ||
                                      J, s[s.length - 1].newStrokeStyle = y, b.setLineDash && (q[p].lineDashType ? (B = q[p].lineDashType, s[s.length - 1].newLineDashArray = P(B, r.lineThickness)) : (B = r.lineDashType, s[s.length - 1].newLineDashArray = D)));
      ...
      l.prototype.renderStepArea = function(a) {
          ...
          function b() {
              y && (0 < h.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? J = z : 0 > a.axisY.viewportMaximum ? J = m.y1 : 0 < a.axisY.viewportMinimum && (J = z), f.lineTo(l, J), f.lineTo(y.x, J), f.closePath(), f.globalAlpha = h.fillOpacity,
                  f.fill(), f.globalAlpha = 1, t && (n.lineTo(l, J), n.lineTo(y.x, J), n.closePath(), n.fill()), f.beginPath(), f.moveTo(l, u), n.beginPath(), n.moveTo(l, u), y = {
                      x: l,
                      y: u
                  })
          }
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  if (0 < C.length) {
                      ...
                      for (; k < C.length; k++)
                          if (s = C[k].x.getTime ? C[k].x.getTime() : C[k].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
                              var Z = u;
                              "number" !== typeof C[k].y ? (h.connectNullData || (c || d) || b(), c = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(C[k].y), d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || L === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l,
                                      c = u, l = r.x, u = r.y, b(), f.moveTo(r.x, r.y), l = d, u = c, y = r, L = h.nullDataLineDashType, f.setLineDash(O)), f.lineTo(l, Z), f.lineTo(l, u), t && (n.lineTo(l, Z), n.lineTo(l, u))) : (f.beginPath(), f.moveTo(l, u), t && (n.beginPath(), n.moveTo(l, u)), y = {
                                      x: l,
                                      y: u
                                  }), c = d = !1) : (f.lineTo(l, Z), t && n.lineTo(l, Z), f.lineTo(l, u), t && n.lineTo(l, u), 0 == k % 250 && b()), r = {
                                      x: l,
                                      y: u
                                  }, k < C.length - 1 && (w !== (C[k].lineColor || v) || L !== (C[k].lineDashType || h.lineDashType)) && (b(), w = C[k].lineColor || v, f.strokeStyle = w, f.setLineDash && (C[k].lineDashType ? (L = C[k].lineDashType,
                                      f.setLineDash(P(L, h.lineThickness))) : (L = h.lineDashType, f.setLineDash(D)))), s = h.dataPointIds[k], this._eventManager.objectMap[s] = {
                                      id: s,
                                      objectType: "dataPoint",
                                      dataSeriesIndex: p,
                                      dataPointIndex: k,
                                  ...
                                  })), (C[k].indexLabel || h.indexLabel || C[k].indexLabelFormatter || h.indexLabelFormatter) &&
                                  this._indexLabels.push({
                                      chartType: "stepArea",
                                      dataPoint: C[k],
                                      dataSeries: h,
      ...
      l.prototype.renderStackedArea = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null,
                  ...
                  q = [],
                  p = 0,
                  h, k, l = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                  ...
                  if (0 < r.length) {
                      ...
                      for (var Z = !0, p = 0; p < r.length; p++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
                              if ("number" !== typeof ia.y) B.connectNullData || (Z || x) || d(), Z = !0;
                              else {
                                  ...
                                  A[f] = l - k;
                                  x || Z ? (!x && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || z === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (x = g.pop(), z = g[g.length - 1], d(), b.moveTo(u.x, u.y), g.push(z), g.push(x), z = B.nullDataLineDashType,
                                      b.setLineDash(O)), b.lineTo(h, k), t && s.lineTo(h, k)) : (b.beginPath(), b.moveTo(h, k), t && (s.beginPath(), s.moveTo(h, k))), Z = x = !1) : (b.lineTo(h, k), t && s.lineTo(h, k), 0 == p % 250 && (d(), b.moveTo(h, k), t && s.moveTo(h, k), g.push({
                                      x: h,
                                      y: l - na
                                  })));
                                  u = {
                                  ...
                                  p < v.length - 1 && (L !== (v[p].lineColor || w) || z !== (v[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, k), g.push({
                                      x: h,
                                      y: l - na
                                  }), L = v[p].lineColor || w, b.strokeStyle = L, b.setLineDash && (v[p].lineDashType ? (z = v[p].lineDashType, b.setLineDash(P(z, B.lineThickness))) : (z =
                                  ...
                                  (ia.indexLabel ||
                                      B.indexLabel || ia.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({
      ...
      l.prototype.renderStackedArea100 = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null,
                  ...
                  q = [],
                  p = 0,
                  h, l, s, aa, u, x = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
              ...
              for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                  ...
                  if (0 < r.length) {
                      var e =
                          B._colorSet[p % B._colorSet.length],
                      ...
                      for (var Z = !0, p = 0; p < r.length; p++) {
                          ...
                          if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !Z)))
                              if ("number" !== typeof ia.y) B.connectNullData ||
                                  (Z || aa) || d(), Z = !0;
                              else {
                                  var na;
                                  ...
                                  k[f] = x - l;
                                  aa || Z ? (!aa && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || u === B.lineDashType &&
                                      B.lineDashType !== B.nullDataLineDashType) && (aa = g.pop(), u = g[g.length - 1], d(), b.moveTo(s.x, s.y), g.push(u), g.push(aa), u = B.nullDataLineDashType, b.setLineDash(O)), b.lineTo(h, l), t && z.lineTo(h, l)) : (b.beginPath(), b.moveTo(h, l), t && (z.beginPath(), z.moveTo(h, l))), Z = aa = !1) : (b.lineTo(h, l), t && z.lineTo(h, l), 0 == p % 250 && (d(), b.moveTo(h, l), t && z.moveTo(h, l), g.push({
                                      x: h,
                                      y: x - ca
                                  })));
                                  s = {
                                  ...
                                  p < w.length - 1 && (L !== (w[p].lineColor || D) || u !== (w[p].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(h, l), g.push({
                                      ...
                                      y: x -
                                          ca
                                  }), L = w[p].lineColor || D, b.strokeStyle = L, b.setLineDash && (w[p].lineDashType ? (u = w[p].lineDashType, b.setLineDash(P(u, B.lineThickness))) : (u = B.lineDashType, b.setLineDash(E))));
                                  if (0 <= B.dataPointIndexes[f]) {
                                  ...
                                  0 <= B.dataPointIndexes[f] && 0 !== ia.markerSize && (0 < ia.markerSize || 0 < B.markerSize) && (ca = B.getMarkerProperties(p, h, l, b), m.push(ca), f = R(F),
                                      t && m.push({
                                          x: h,
                                          y: l,
                                          ctx: z,
      ...
      l.prototype.renderBubble = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var m = -Infinity, k = Infinity, g = 0; g < a.dataSeriesIndexes.length; g++)
                  for (var r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints,
                          h = 0, e = 0; e < p.length; e++) f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof p[e].z || (h = p[e].z, h > m && (m = h), h < k && (k = h));
              for (var l = 25 * Math.PI, s = Math.max(Math.pow(0.25 * Math.min(b.height, b.width) / 2, 2) * Math.PI, l), g = 0; g < a.dataSeriesIndexes.length; g++)
                  if (r = a.dataSeriesIndexes[g], q = this.data[r], p = q.dataPoints, 0 < p.length)
                  ...
                  if (0 < r.length) {
                      ...
                      for (var q = 0, p = 0, e = 0; e < r.length; e++)
                          if (f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[e].y) {
                              ...
                              c.globalAlpha = 1;
                              Math.sqrt((q - f) * (q - f) + (p - n) * (p - n)) < Math.min(h.size, 5) && r.length > Math.min(this.plotArea.width,
                                  this.plotArea.height) || (q = g.dataPointIds[e], this._eventManager.objectMap[q] = {
                                      id: q,
                                      objectType: "dataPoint",
                                      dataSeriesIndex: k,
                                      dataPointIndex: e,
      ...
      l.prototype.renderCandlestick = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null,
                  ...
                  n = this.plotArea,
                  m = 0,
                  k, g, r, q, p, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
              ...
              for (var ga = 0; ga < a.dataSeriesIndexes.length; ga++) {
                  ...
                  if (0 < x.length)
                      for (var z = 5 < l && u.bevelEnabled ? !0 : !1, m = 0; m < x.length; m++)
                          if (x[m].getTime ? h = x[m].x.getTime() : h = x[m].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[m].y) && x[m].y.length && "number" === typeof x[m].y[0] &&
      ...
      l.prototype.renderBoxAndWhisker = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null,
                  f = this.plotArea,
                  n = 0,
                  m, k, g, r, q, p, h, e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1,
              ...
              for (var ga = !1, ga = !!a.axisY.reversed, aa = 0; aa < a.dataSeriesIndexes.length; aa++) {
                  ...
                  if (0 < z.length)
                      for (var v = 5 < l && x.bevelEnabled ? !0 : !1, n = 0; n < z.length; n++)
                          if (z[n].getTime ? h = z[n].x.getTime() : h = z[n].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(z[n].y) && z[n].y.length && "number" === typeof z[n].y[0] && "number" === typeof z[n].y[1] && "number" === typeof z[n].y[2] && "number" === typeof z[n].y[3] && "number" === typeof z[n].y[4] && 5 === z[n].y.length) {
                              ...
                              var y = m - l / 2 << 0,
                                  ...
                                  I = z[n].stemDashType ? z[n].stemDashType :
                                  x.stemDashType,
                              ...
                              c.restore();
                              c.save();
                              0 < O && (c.beginPath(), c.setLineDash && c.setLineDash(P(E, O)), c.strokeStyle = L, c.lineWidth = O, c.moveTo(m - Z / 2 << 0, q - ia), c.lineTo(m + Z / 2 << 0, q - ia),
                                  c.stroke(), c.moveTo(m - Z / 2 << 0, k + ia), c.lineTo(m + Z / 2 << 0, k + ia), c.stroke());
                              c.restore();
                              t && (e = R(Q), b.strokeStyle = e, b.lineWidth = ca, 0 < ca && (b.moveTo(m - D - F, g), b.lineTo(m - D - F, Math.max(k, q)), b.stroke(), b.moveTo(m - D - F, Math.min(k, q)), b.lineTo(m - D - F, r), b.stroke()), da(b, y, Math.max(g, r), B, Math.min(g, r), e, 0, null, !1, !1, !1, !1), 0 < O && (b.beginPath(), b.lineWidth = O, b.moveTo(m + Z / 2, q - ia), b.lineTo(m - Z / 2, q - ia), b.stroke(), b.moveTo(m + Z / 2, k + ia), b.lineTo(m - Z / 2, k + ia), b.stroke()));
      ...
      l.prototype.renderRangeColumn = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null,
                  e = this.plotArea,
                  f = 0,
                  n, m, k, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth :
                  1;
              ...
              for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                  ...
                  if (0 < h.length)
                      for (var l =
                              5 < g && p.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)
                          if (h[f].getTime ? k = h[f].x.getTime() : k = h[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                              b = a.axisX.convertValueToPixel(k);
                              n = a.axisY.convertValueToPixel(h[f].y[0]);
                              m = a.axisY.convertValueToPixel(h[f].y[1]);
                              var ga = a.axisX.reversed ? b + a.plotType.totalDataSeries * g / 2 - (a.previousDataSeriesCount + r) * g << 0 : b - a.plotType.totalDataSeries * g / 2 + (a.previousDataSeriesCount +
                                      r) * g << 0,
      ...
      l.prototype.renderError = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var e = null,
                  ...
                  n = this.plotArea,
                  m = 0,
                  k, g, r, q, p, h, l, ga = a.axisX.dataInfo.minDiff;
              ...
              t && (this._eventManager.ghostCtx.beginPath(),
                  this._eventManager.ghostCtx.rect(n.x1, n.y1, n.width, n.height), this._eventManager.ghostCtx.clip());
              for (var aa = 0, u = 0; u < this.data.length; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && aa || aa++;
              for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                  var z = a.dataSeriesIndexes[x],
                      ...
                      D = 0;
                  if (B)
                      for (e = v._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) ||
                          !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && D || (this.data[u].type.match(/(range)/ig) && (f = !0), D++);
                  ...
                  f && (m = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth :
                      b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (B ? aa : 1))) << 0 : 0.03 * this.width);
                      ...
                      for (var E = v._colorSet, m = 0; m < y.length; m++) {
                          ...
                          var O = {
                              ...
                              dashType: y[m].stemDashType ?
                                  y[m].stemDashType : v.stemDashType
                          };
                          ...
                          if (!(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && !s(y[m].y) && y[m].y.length && "number" === typeof y[m].y[0] && "number" === typeof y[m].y[1]) {
                              ...
                              b ? q = ha : h = ha;
                              b ? (p = a.axisX.reversed ? g + (B ? aa :
                                  1) * u / 2 - (B ? D - 1 : 0) * u << 0 : g - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) * u << 0, h = a.axisX.reversed ? p - u << 0 : p + u << 0) : (r = a.axisX.reversed ? k + (B ? aa : 1) * u / 2 - (B ? D - 1 : 0) * u << 0 : k - (B ? aa : 1) * u / 2 + (B ? D - 1 : 0) * u << 0, q = a.axisX.reversed ? r - u << 0 : r + u << 0);
                              !b && p > h && (ha = p, p = h, h = ha);
                              b && r > q && (ha = r, r = q, q = ha);
                              ha = v.dataPointIds[m];
                              ...
                              w(c, Math.min(r,
                                  q), Math.min(p, h), Math.max(q, r), Math.max(h, p), e, L, O, b);
      ...
      l.prototype.renderRangeBar = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = null,
                  e = this.plotArea,
                  f = 0,
                  n, m, k, g, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
              ...
              for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                  ...
                  if (0 < l.length) {
                      ...
                      for (f = 0; f < l.length; f++)
                          if (l[f].getTime ? g = l[f].x.getTime() : g = l[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(l[f].y) && l[f].y.length && "number" === typeof l[f].y[0] && "number" === typeof l[f].y[1]) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              ...
              for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if (0 < q.length) {
                      ...
                      for (var L = !0; h <
                          q.length; h++)
                          if (u = q[h].x.getTime ? q[h].x.getTime() : q[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!r.connectNullData || !L)))
                              if (null !== q[h].y && q[h].y.length && "number" === typeof q[h].y[0] && "number" === typeof q[h].y[1]) {
                                  ...
                                  p || L ? (r.connectNullData && !p ? (b.setLineDash && (r.options.nullDataLineDashType || B === r.lineDashType && r.lineDashType !== r.nullDataLineDashType) && (k[k.length -
                                      1].newLineDashArray = E, B = r.nullDataLineDashType, b.setLineDash(D)), b.lineTo(l, s), t && e.lineTo(l, s), k.push({
                                      x: l,
                                      y: v
                                  ...
                                  h < q.length - 1 && (y !== (q[h].lineColor || w) || B !== (q[h].lineDashType || r.lineDashType)) && (d(),
                                      y = q[h].lineColor || w, k[k.length - 1].newStrokeStyle = y, b.strokeStyle = y, b.setLineDash && (q[h].lineDashType ? (B = q[h].lineDashType, k[k.length - 1].newLineDashArray = P(B, r.lineThickness), b.setLineDash(k[k.length - 1].newLineDashArray)) : (B = r.lineDashType, k[k.length - 1].newLineDashArray = E, b.setLineDash(E))));
      ...
      l.prototype.renderRangeSplineArea = function(a) {
          function d(a, c) {
              ...
              if (0 < d.length) {
                  ...
                  d = v(aa, 2);
                  b.lineTo(aa[aa.length - 1].x, aa[aa.length -
                      1].y);
                  ...
                  if (0 < g.lineThickness) {
                      ...
                      for (var h = f = 0; f < d.length - 3; f += 3, h++) {
                          if (s[h].newStrokeStyle || s[h].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x,
                              d[f].y), s[h].newStrokeStyle && (b.strokeStyle = s[h].newStrokeStyle), s[h].newLineDashArray && b.setLineDash(s[h].newLineDashArray);
                          b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y)
                      }
                      b.stroke()
                  }
              ...
              for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                  ...
                  if (0 < r.length) {
                      ...
                      for (h = !1; q < r.length; q++)
                          if (p = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !h)))
                              if (null !== r[q].y && r[q].y.length && "number" === typeof r[q].y[0] && "number" === typeof r[q].y[1]) {
                                  ...
                                  q < r.length - 1 && (z !== (r[q].lineColor || x) || w !== (r[q].lineDashType || g.lineDashType)) && (z = r[q].lineColor || x, s[s.length - 1].newStrokeStyle = z, b.setLineDash && (r[q].lineDashType ? (w = r[q].lineDashType, s[s.length - 1].newLineDashArray = P(w, g.lineThickness)) : (w = g.lineDashType, s[s.length - 1].newLineDashArray = y)));
                                  ...
                                  h = !1
                              } else 0 < q && !h && (g.connectNullData ? b.setLineDash && (0 < s.length && (g.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = B, w = g.nullDataLineDashType) : (d(y, x), s = [], aa = [])), h = !0;
                      d(y, x);
                      X.drawMarkers(f)
                  }
              }
      ...
      l.prototype.renderWaterfall = function(a) {
          ...
          if (!(0 >= a.dataSeriesIndexes.length)) {
              var b = this._eventManager.ghostCtx,
                  ...
                  f = this.plotArea,
                  n = 0,
                  m, k, g, r, q = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
                  ...
                  if (0 < v.length)
                      for (var z = 5 < p && s.bevelEnabled ? !0 : !1, w = !1, y = null, B = null, n = 0; n < v.length; n++)
                          if (v[n].getTime ? r = v[n].x.getTime() : r = v[n].x, "number" !== typeof v[n].y) {
                              ...
                              0 < n && y && (!w || s.connectNullData) && (w && c.setLineDash && c.setLineDash(P(D, u)), c.beginPath(), c.moveTo(y, B - x), c.lineTo(L, O - x), 0 < u && c.stroke(), t &&
                                  (b.beginPath(), b.moveTo(y, B - x), b.lineTo(L, O - x), 0 < u && b.stroke()));
                              w = !1;
                              y = E;
                              B = 0 < v[n].y ? k : g;
      ...
      l.prototype.renderPie = function(a) {
              ...
              if (g && r) {
                  for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < r.length; e++) {
                      ...
                      m.indexLabelMaxWidth =
                          f.indexLabelMaxWidth ? f.indexLabelMaxWidth : g.indexLabelMaxWidth ? g.indexLabelMaxWidth : 0.33 * p.width;
          ...
          function c(a) {
              ...
              for (b = 0; b < r.length; b++) {
                  ...
                  if (d > c) {
                      ...
                      } else if (0 < Math.abs(h[b].center.x - z.x) || 0 < Math.abs(h[b].center.y - z.y)) h[b].center.x = z.x +
                          e * (1 - a), h[b].center.y = z.y + f * (1 - a), m = !0;
              ...
              a.lineJoin = "round";
              for (b = b = 0; b < r.length; b++) c = h[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d =
                  0, d = "left" === c.hemisphere ? "inside" !== g.indexLabelPlacement ? -(c.indexLabelTextBlock.width + q) : -c.indexLabelTextBlock.width / 2 : "inside" !== g.indexLabelPlacement ? q : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + B * Math.cos(c.midAngle), e = c.center.y + B * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor,
                      a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(P(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -q : q), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
              a.save()
          }
          ...
          function e(a) {
              for (var c = null, d = 1; d < r.length; d++)
                  if (c = (a + d + h.length) % h.length, h[c].hemisphere !== h[a].hemisphere) {
                      c = null;
                      break
                  } else if (h[c].indexLabelText && c !== a && (0 > b(h[c], h[a]) || ("right" === h[a].hemisphere ? h[c].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y : h[c].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y))) break;
              else c = null;
              return c
          }
          ...
          function f(a, c, d) {
              ...
              if (0 <= a && a < r.length) {
                  ...
                  for (n = 1; n < r.length; n++)
                      if (m = (a - n + h.length) % h.length, h[m].hemisphere !== h[a].hemisphere) {
                          m = null;
                          break
                      } else if (h[m].indexLabelText &&
                      h[m].hemisphere === h[a].hemisphere && m !== a && (0 > b(h[m], h[a]) || ("right" === h[a].hemisphere ? h[m].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[m].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break;
                  else m = null;
                  q = m;
                  p = e(a);
                  n = m = 0;
                  0 > c ? (n = "right" === k.hemisphere ? q : p, g = c, null !== n && (q = -c, c = k.indexLabelTextBlock.y - k.indexLabelTextBlock.height / 2 - (h[n].indexLabelTextBlock.y + h[n].indexLabelTextBlock.height / 2), c - q < l && (m = -q, n = f(n, m, d + 1), +n.toFixed(x) > +m.toFixed(x) && (g = c > l ? -(c - l) : -(q - (n - m)))))) : 0 < c && (n = "right" ===
                      k.hemisphere ? p : q, g = c, null !== n && (q = c, c = h[n].indexLabelTextBlock.y - h[n].indexLabelTextBlock.height / 2 - (k.indexLabelTextBlock.y + k.indexLabelTextBlock.height / 2), c - q < l && (m = q, n = f(n, m, d + 1), +n.toFixed(x) < +m.toFixed(x) && (g = c > l ? c - l : q - (m - n)))));
                  g && (d = k.indexLabelTextBlock.y + g, c = 0, c = "right" === k.hemisphere ? z.x + Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)) : z.x - Math.sqrt(Math.pow(t, 2) - Math.pow(d - z.y, 2)), k.midAngle > Math.PI / 2 - u && k.midAngle < Math.PI / 2 + u ? (m = (a - 1 + h.length) % h.length, m = h[m], a = h[(a + 1 + h.length) % h.length], "left" ===
                      ...
                      for (var u, s, a = 0; a < r.length; a++) {
                          ...
                          if (null !== y) {
                              ...
                              if (0 > w) {
                                  ...
                                  var J = -1 * (w - s),
                                      G = I = 0;
                                  "right" === n.hemisphere ? (I = f(a, s), J = -1 * (w - I), G = f(y, J), +G.toFixed(x) <
                                      +J.toFixed(x) && +I.toFixed(x) <= +s.toFixed(x) && f(a, -(J - G))) : (I = f(y, s), J = -1 * (w - I), G = f(a, J), +G.toFixed(x) < +J.toFixed(x) && +I.toFixed(x) <= +s.toFixed(x) && f(y, -(J - G)))
                              }
                          }
                      }
                  } else
                      for (a = 0; a < r.length; a++) n = h[a], t = "pie" === g.type ? 0.7 * B : 0.8 * B, y = z.x + t * Math.cos(n.midAngle), s = z.y + t * Math.sin(n.midAngle), n.indexLabelTextBlock.x = y, n.indexLabelTextBlock.y = s;
                  for (a = 0; a < r.length; a++)
                      if (n = h[a], y = n.indexLabelTextBlock.measureText(), 0 !== y.height && 0 !== y.width) y = y = 0, "right" === n.hemisphere ? (y = p.x2 - (n.indexLabelTextBlock.x + n.indexLabelTextBlock.width +
                  ...
                  this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                      ...
                      for (b = 0; b < r.length; b++) {
                          ...
                          d > c && Y(k.plotArea.ctx,
                              h[b].center, h[b].radius, f, g.type, c, d, g.fillOpacity, h[b].percentInnerRadius);
                          if (e) break
                      }
                      m()
                  }, function() {
      ...
      l.prototype.renderFunnel = function(a) {
          ...
          function c() {
              ...
              for (var d = [], h = 0, g = 0; g < x.length; g++) {
                  if ("undefined" === typeof x[g].y) return -1;
                  x[g].y = "number" === typeof x[g].y ? x[g].y : 0;
                  h += Math.abs(x[g].y)
              }
              if (0 === h) return -1;
              for (var n = d[0] = 0, m = 0, k, r, b = b - a, n = !1, g = 0; g < x.length; g++) a = Math.abs(x[g].y) * f / h, n ? k = 0 == Number(c.toFixed(3)) ? 0 : a / c : (r = ba * ba * b * b - 4 * Math.abs(ba) * a, 0 > r ? (r = c, n = (b + r) * (e - m) / 2, a -= n, k = e - m, m += e - m, k += 0 == r ? 0 : a / r, m += a / r, n = !0) : (k = (Math.abs(ba) * b - Math.sqrt(r)) / 2, r = b - 2 * k / Math.abs(ba), m += k, m > e && (m -= k, r =
          ...
          function b() {
              if (u && x) {
                  ...
                  for (var y = 0, B = x.length - 1; y < x.length || 0 <= B; y++, B--) {
                      ...
                      "inside" === u.indexLabelPlacement && (A[y] = y !== da ? u.reversed ? Q[y].x2 - Q[y].x1 :
                          Q[y].x3 - Q[y].x4 : Q[y].x3 - Q[y].x6, 20 > A[y] && (A[y] = y !== da ? u.reversed ? Q[y].x3 - Q[y].x4 : Q[y].x2 - Q[y].x1 : Q[y].x2 - Q[y].x1, A[y] /= 2));
          ...
          function e() {
              ...
              if (e)
                  for (m = H.length - 1; 0 <= m; m--) a = Q[m], H[m].textBlock.maxWidth =
                      ...
                      (H[m].textBlock.y < T - D && (H[m].textBlock.y = T - D), H[m].textBlock.y + H[m].height > sa + D && (H[m].textBlock.y = sa + D - H[m].height))
          }

          function f() {
              var a, b, c, d;
              if ("inside" !== u.indexLabelPlacement)
                  for (var e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? h(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? h(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, H[e].textBlock.x = b + V, H[e].textBlock.y =
                      c - H[e].height / 2, u.reversed ? (H[e].textBlock.y + H[e].height > T + D && (H[e].textBlock.y = T + D - H[e].height), H[e].textBlock.y < sa - D && (H[e].textBlock.y = sa - D)) : (H[e].textBlock.y < T - D && (H[e].textBlock.y = T - D), H[e].textBlock.y + H[e].height > sa + D && (H[e].textBlock.y = sa + D - H[e].height)));
              else
                  for (e = 0; e < Q.length; e++) 0 == H[e].textBlock.text.length ? H[e].isDirty = !0 : (a = Q[e], b = a.height, c = H[e].height, d = H[e].width, b >= c ? (b = e != da ? (a.x4 + a.x3) / 2 - d / 2 : (a.x5 + a.x4) / 2 - d / 2, c = e != da ? (a.y1 + a.y3) / 2 - c / 2 : (a.y1 + a.y4) / 2 - c / 2, H[e].textBlock.x = b, H[e].textBlock.y =
                      c) : H[e].isDirty = !0)
          }
          ...
          function n() {
              ...
              function b() {
                  ...
                  for (var m, n = 1; n < g; n++) {
                      e = n * f;
                      for (var r = H.length - 1; 0 <= r; r--) !H[r].isDirty && (H[r].textBlock.y < e && H[r].textBlock.y +
                          H[r].height > e) && (m = p(r), !(m >= H.length - 1) && H[r].textBlock.y + H[r].height + ea > H[m].textBlock.y && (H[r].textBlock.y = H[r].textBlock.y + H[r].height - e > e - H[r].textBlock.y ? e + 1 : e - H[r].height - 1))
                  }
              ...
              for (var d, e, f, h, g, n, k = 1, r = 0; r < 2 * k; r++) {
                  for (var l = H.length - 1; 0 <= l && !(0 <= q(l) && q(l), f = H[l], h = f.textBlock, n = (g = p(l) < Q.length ?
                          H[p(l)] : null) ? g.textBlock : null, d = +f.height.toFixed(6), e = +h.y.toFixed(6), !f.isDirty && (g && e + d + ea > +n.y.toFixed(6)) && (d = h.y + d + ea - n.y, e = a(l, -d), e < d && (0 < e && (d -= e), e = a(p(l), d), e != d))); l--);
                  b()
              }
          }
          ...
          function k(a, b, c) {
              var d, e, h, m = [],
                  n = D,
                  q = []; - 1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function(a, b) {
                  return a - b
              })));
              if (0 === Y.length) m = ja;
              else {
                  e = D * (1 != Y.length ||
                      0 != Y[0] && Y[0] != Q.length - 1 ? 2 : 1) / g();
              ...
              var s = {
                  ...
                  changeSection: function(a) {
                      for (var b, c, d = 0; d < Q.length; d++) b = h[d], c = Q[d], b *= a, "undefined" ===
                          typeof q[d] && (q[d] = 0), 0 > q && (q *= -1), c.y1 += b - q[d], c.y2 += b - q[d], c.y3 += b - q[d], c.y4 += b - q[d], c.y5 && (c.y5 += b - q[d], c.y6 += b - q[d]), q[d] = b
                  }
              };
              a._animator.animate(0, c, function(c) {
                  ...
                  for (e = 0; e < Q.length; e++) qa(d,
                      Q[e], u.fillOpacity);
                  v(d);
                  L && ("inside" !== u.indexLabelPlacement ? r(d) : f(), l(d));
                  1 <= c && (ka = !1)
          ...
          function r(a) {
              for (var b, c, d, e, f = 0; f < Q.length; f++) e = 1 === H[f].lineThickness % 2 ? 0.5 : 0, c = ((Q[f].y2 + Q[f].y4) / 2 << 0) + e, b = h(c).x2 - 1, d = H[f].textBlock.x, e = (H[f].textBlock.y + H[f].height / 2 << 0) + e, H[f].isDirty || 0 == H[f].lineThickness || (a.strokeStyle = H[f].lineColor, a.lineWidth = H[f].lineThickness, a.setLineDash &&
                  a.setLineDash(P(H[f].lineDashType, H[f].lineThickness)), a.beginPath(), a.moveTo(b, c), a.lineTo(d, e), a.stroke())
          }
          ...
          function l(a) {
              for (var b =
                      0; b < Q.length; b++) H[b].isDirty || (a && (H[b].textBlock.ctx = a), H[b].textBlock.render(!0))
          }
          ...
          function v(a) {
              ...
              w.legend && (w.legend.dockInsidePlotArea ||
                  "center" === w.legend.horizontalAlign && "center" === w.legend.verticalAlign) && (w.legend.ctx = a, w.legend.setLayout(), w.legend.render());
              I.fNg && I.fNg(w)
          }
          var w = this;
          if (!(0 >= a.dataSeriesIndexes.length)) {
              for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, z = this.plotArea, D = 0.025 * z.width, y = 0.01 * z.width, B = 0, E = z.height - 2 * D, G = Math.min(z.width - 2 * y, 2.8 * z.height), L = !1, O = 0; O < x.length; O++)
                  if (!L && ("undefined" !== typeof x[O].indexLabel && null !== x[O].indexLabel && 0 < x[O].indexLabel.toString().length) && (L = !0), !L && ("undefined" !==
                          typeof x[O].label && null !== x[O].label && 0 < x[O].label.toString().length) && (L = !0), !L && "function" === typeof u.indexLabelFormatter || "function" === typeof x[O].indexLabelFormatter) L = !0;
              ...
              if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                  ...
                  var V =
                      30 * (M - a) / 100;
                  "funnel" === u.type ? (ca = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight, F = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof ca && ca.match(/%$/) ? (ca = parseInt(ca), ca = ca * E / 100) : ca = parseInt(ca), "string" === typeof F && F.match(/%$/) ? (F = parseInt(F), F = F * a / 100) : F = parseInt(F), ca > E ? ca = E : 0 >= ca && (ca = 0), F > a ? F = a - 0.5 : 0 >= F && (F = 0)) : "pyramid" === u.type && (F = ca = 0, u.reversed = u.reversed ? !1 : !0);
                  var y = O + a / 2,
                      W = O,
                      $ = O + a,
                      T = u.reversed ? S : Z,
                  ...
                  var y = [],
                      ...
                      da, ba = (xa - T) / (K - W),
                      fa = -ba,
                      O = "area" === (u.valueRepresents ? u.valueRepresents : "height") ? c() : d();
                  if (-1 !== O) {
                      if (u.reversed)
                          for (G.push(U), F = O.length - 1; 0 < F; F--) U += O[F], G.push(U);
                      else
                          for (F = 0; F < O.length; F++) U += O[F], G.push(U);
                      if (u.reversed)
                          for (F = 0; F < O.length; F++) G[F] < xa ? (a.push(K), y.push(X), da = F) : (a.push((G[F] - T + ba * W) / ba), y.push((G[F] - T + fa * $) / fa));
                      else
                          for (F = 0; F < O.length; F++) G[F] < xa ? (a.push((G[F] - T + ba * W) / ba), y.push((G[F] - T + fa * $) / fa), da = F) : (a.push(K), y.push(X));
                      for (F = 0; F < O.length - 1; F++) U = u.reversed ?
                          x[x.length - 1 - F].color ? x[x.length - 1 - F].color : u._colorSet[(x.length - 1 - F) % u._colorSet.length] : x[F].color ? x[F].color : u._colorSet[F % u._colorSet.length], F === da ? Q.push({
                              x1: a[F],
                              y1: G[F],
                              x2: y[F],
                              y2: G[F],
                      ...
                      a = a = 0;
                      Ca(Y);
                      for (F = 0; F < x.length; F++) x[F].exploded && (O = !0, u.reversed ?
                          Y.push(x.length - 1 - F) : Y.push(F));
                      ...
                      v(R);
                      L && u.visible && ("inside" === u.indexLabelPlacement || w.animationEnabled || r(R), w.animationEnabled || l());
                      if (!L)
                          for (F = 0; F < x.length; F++) B = u.dataPointIds[F], a = {
                              id: B,
                              objectType: "dataPoint",
                              dataPointIndex: F,
                              dataSeriesIndex: 0,
                      ...
                      this.funnelPyramidClickHandler = function(a) {
                          var b = -1;
                          if (!ka && !w.isAnimating && (s(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) &&
          ...
          return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
              ...
              if ("x" === a)
                  if ("dateTime" === c.axisX.valueType || "dateTime" === c.xValueType || d.x && d.x.getTime) {
                      ...
                      c.xValueFormatString = "#,##0.########", f._cultureInfo);
              else return "y" === a ? fa(h, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? fa(h, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : h
          })
      };
      oa(E, W);
                  ...
                  if ("pie" !== q.type && "doughnut" !== q.type && "funnel" !== q.type && "pyramid" !== q.type) {
                      ...
                      for (var x = 0; x < q.dataPoints.length; x++) {
                          var z = q.dataPoints[x],
                              ...
                              l = z.legendMarkerColor ? z.legendMarkerColor :
      ...
      G.prototype.getDataPointAtX = function(a, d) {
          ...
          for (;;) {
              ...
              } else if (0 > r - e && r + e >= this.dataPoints.length) break; - 1 === n ? (e++, n = 1) : n = -1
          }
      ...
      G.prototype.getDataPointAtXY = function(a, d, c) {
          ...
          if ("none" !== this.chart.plotInfo.axisPlacement)
              ...
              else p = this.dataPoints[this.dataPoints.length - 1].x - this.dataPoints[0].x, q = 0 < p ? Math.min(Math.max((this.dataPoints.length - 1) / p * (q - this.dataPoints[0].x) >> 0, 0), this.dataPoints.length) : 0;
          for (;;) {
              f = 0 < n ? q + e : q - e;
              if (0 <= f && f < this.dataPoints.length) {
      ...
      D.prototype.createLabels = function() {
          ...
          if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
              ...
              if (this.logarithmic && !this.equidistantInterval)
                  for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, h = p; b < this.logLabelValues.length; b++)
                      if (c =
          ...
          else if ("left" === this._position || "right" === this._position) m = this.logarithmic && !this.equidistantInterval && 2 <= this._labels.length ? this.lineCoordinates.height * Math.log(Math.min(this._labels[this._labels.length -
          ...
          if (this.labelAutoFit || this.options.labelAutoFit)
              if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position)
                  if (f = 0.9 * m >> 0, p = 0, !this.chart.panEnabled &&
                                  ...
                                  if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? n : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), l = (g - (k + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ?
                                      ...
                                      if (s(this.options.labelWrap))
                                          if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ?
                                              (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = n);
                                          else if (!s(d))
                                          if (b = C.width + d.width >> 0, h = this.labelFontSize, p < f) b - 2 * f > q && (q = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ?
                                              ...
                                              h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = l, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = l) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = n, this.sessionVariables.labelAngle = this.labelAngle));
                                          else if (v === c && (0 === v && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q || v === this._labels.length - 1 && p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q || 0 < v && v < this._labels.length - 1 && p + this._labels[v + 1].textBlock.measureText().width - 2 * f > q &&
                                              p + this._labels[v - 1].textBlock.measureText().width - 2 * f > q)) q = 0 === v ? p + this._labels[v + 1].textBlock.measureText().width - 2 * f : p + this._labels[v - 1].textBlock.measureText().width - 2 * f, this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = l;
                                      else if (0 === q)
              ...
              if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, n = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                  this.sessionVariables.labelFontSize = this.labelFontSize;
                  this.sessionVariables.labelMaxWidth = f;
                  this.sessionVariables.labelMaxHeight = n;
      ...
      D.setLayout = function(a, d, c, b, e, f) {
          var n, m, k, g, l = a[0] ? a[0].chart : d[0].chart,
          ...
          for (h = 0; h < p.length; h++)
              if (p[h] && p[h].scaleBreaks && p[h].scaleBreaks._appliedBreaks.length)
                  for (var t = p[h].scaleBreaks._appliedBreaks, v = 0; v < t.length && !(t[v].startValue > p[h].viewportMaximum); v++) t[v].endValue < p[h].viewportMinimum || (s(p[h].scaleBreaks.firstBreakIndex) && (p[h].scaleBreaks.firstBreakIndex = v), t[v].startValue >= p[h].viewPortMinimum && (p[h].scaleBreaks.lastBreakIndex =
                      v));
          ...
          for (h = 0; h < p.length; h++)
              if (p[h].title) switch (p[h]._position) {
                  case "left":
          ...
          if ("normal" === e) {
              for (var x = [], z = [], D = [], y = [], N = [], P = [], R = [], S = []; 4 > v;) {
                  var F = 0,
                      ...
                      ba = 0;
                  if (c && 0 < c.length)
                      for (D = [], h = Q = 0; h < c.length; h++) D.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateWidth() : 0)), Q += D[h], K += c[h] && !l.isNavigator ? c[h].margin : 0;
                  else D.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateWidth() : 0));
                  R.push(D);
                  if (b && 0 < b.length)
                      for (y = [], h = ba = 0; h <
                          b.length; h++) y.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateWidth() : 0)), ba += y[h], $ += b[h] ? b[h].margin : 0;
                  ...
                  if (a && 0 < a.length)
                      for (x = [], h = U = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates = {}), a[h].lineCoordinates.width = Math.abs(k - n), a[h].title && (a[h]._titleTextBlock.maxWidth = 0 < a[h].titleMaxWidth && a[h].titleMaxWidth < a[h].lineCoordinates.width ? a[h].titleMaxWidth :
                          a[h].lineCoordinates.width), x.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateHeight() : 0)), U += x[h], e += a[h] && !l.isNavigator ? a[h].margin : 0;
                  else x.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateHeight() : 0));
                  N.push(x);
                  if (d && 0 < d.length)
                      for (z = [], h = X = 0; h < d.length; h++) d[h] && (d[h].lineCoordinates = {}), d[h].lineCoordinates.width = Math.abs(k - n), d[h].title && (d[h]._titleTextBlock.maxWidth = 0 < d[h].titleMaxWidth && d[h].titleMaxWidth < d[h].lineCoordinates.width ? d[h].titleMaxWidth : d[h].lineCoordinates.width), z.push(Math.ceil(d[h] ?
                  ...
                  P.push(z);
                  if (a && 0 < a.length)
                      for (h = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates.x1 = n, k = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), a[h]._labels && 1 < a[h]._labels.length && (m = g = 0, g = a[h]._labels[1], m = "dateTime" === a[h].valueType ? a[h]._labels[a[h]._labels.length - 2] : a[h]._labels[a[h]._labels.length - 1], w = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) +
                  ...
                  if (d && 0 < d.length)
                      for (h = 0; h < d.length; h++) d[h].lineCoordinates.x1 = Math.round(f.x1 + Q + K), d[h].lineCoordinates.x2 = Math.round(f.x2 - ba - $ > l.width - q ? l.width - q : f.x2 - ba - $), d[h].lineCoordinates.width = Math.abs(k -
                  ...
                  if (c && 0 < c.length)
                      for (h = 0; h < c.length; h++) K = l.isNavigator ? 0 : 10, c[h] && (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), K = c[h]._labels && 0 < c[h]._labels.length ?
                  ...
                  if (a && 0 < a.length)
                      for (h = 0; h < a.length; h++) a[h] && (a[h].calculateValueToPixelConversionParameters(), a[h].calculateBreaksSizeInValues(), a[h]._labels && 1 < a[h]._labels.length && (B = (a[h].logarithmic ? Math.log(a[h]._labels[1].position /
                  ...
                  if (0 < v) {
                      if (a && 0 < a.length)
                          for (h = 0; h < a.length; h++) t = N[v - 1][h] === N[v][h] ? !0 : !1;
                      else t = !0;
                      if (d && 0 < d.length)
                          for (h = 0; h < d.length; h++) I = P[v - 1][h] === P[v][h] ? !0 : !1;
                      else I = !0;
                      if (c && 0 < c.length)
                          for (h = 0; h < c.length; h++) O = R[v - 1][h] === R[v][h] ? !0 : !1;
                      else O = !0;
                      if (b && 0 < b.length)
                          for (h = 0; h < b.length; h++) M = S[v - 1][h] === S[v][h] ? !0 : !1;
                      else M = !0
                  }
                  if (t && I && O && M) break;
                  v++
              ...
              for (P = []; 4 > v;) {
                  ...
                  if (a && 0 < a.length)
                      for (G = [], h = W = 0; h < a.length; h++) G.push(Math.ceil(a[h] ? a[h].createLabelsAndCalculateWidth() : 0)), W += G[h], e += a[h] && !l.isNavigator ? a[h].margin : 0;
                  else G.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() :
                      0));
                  N.push(G);
                  if (d && 0 < d.length)
                      for (w = [], h = U = 0; h < d.length; h++) w.push(Math.ceil(d[h] ? d[h].createLabelsAndCalculateWidth() : 0)), U += w[h], Y += d[h] ? d[h].margin : 0;
                  else w.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateWidth() : 0));
                  P.push(w);
                  if (c && 0 < c.length)
                      for (h = 0; h < c.length; h++) c[h].lineCoordinates = {}, n = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > l.width - 10 ? l.width - 10 : f.x2 - U - Y), c[h].labelAutoFit && !s(x) && (0 < !a.length && (n = 0 > c[h].labelAngle ? Math.max(n, x) : 0 === c[h].labelAngle ? Math.max(n, x / 2) : n), 0 < !d.length && (k =
                  ...
                  if (b && 0 < b.length)
                      for (h = 0; h < b.length; h++) b[h].lineCoordinates = {}, n = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > b[h].chart.width - 10 ? b[h].chart.width - 10 : f.x2 - U - Y), b[h] && b[h].labelAutoFit && !s(D) && (0 < !a.length &&
                  ...
                  if (c && 0 < c.length)
                      for (q = [], h = T = 0; h < c.length; h++) q.push(Math.ceil(c[h] ? c[h].createLabelsAndCalculateHeight() : 0)), T += q[h] + c[h].margin, K += c[h].margin;
                  else q.push(Math.ceil(c[0] ?
                      c[0].createLabelsAndCalculateHeight() : 0));
                  E.push(q);
                  if (b && 0 < b.length)
                      for (B = [], h = V = 0; h < b.length; h++) B.push(Math.ceil(b[h] ? b[h].createLabelsAndCalculateHeight() : 0)), V += B[h], $ += b[h].margin;
                  else B.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                  u.push(B);
                  if (c && 0 < c.length)
                      for (h = 0; h < c.length; h++) 0 < c[h]._labels.length && (g = c[h]._labels[0], m = c[h]._labels[c[h]._labels.length - 1], x = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI /
                  ...
                  if (b && 0 < b.length)
                      for (h = 0; h < b.length; h++) b[h] && 0 < b[h]._labels.length && (g = b[h]._labels[0], m = b[h]._labels[b[h]._labels.length - 1], D = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - m.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle)), y = m.textBlock.width *
                  ...
                  if (l.panEnabled)
                      for (h = 0; h < c.length; h++) q[h] = s(l.sessionVariables.axisY.height) ? l.sessionVariables.axisY.height = q[h] : l.sessionVariables.axisY.height;
                  else
                      for (h = 0; h < c.length; h++) l.sessionVariables.axisY.height = q[h];
                  if (c && 0 < c.length)
                      for (h = c.length - 1; 0 <= h; h--) m = Math.round(f.y2), g = Math.round(f.y2 > c[h].chart.height ? c[h].chart.height : f.y2), c[h].lineCoordinates.y1 =
                  ...
                  if (b && 0 < b.length)
                      for (h = b.length - 1; 0 <= h; h--) b[h] && (m = Math.round(f.y1), g = Math.round(f.y1 + (B[h] + b[h].margin + F)), b[h].lineCoordinates.y1 = g, b[h].lineCoordinates.y2 = g,
                          b[h].bounds = {
                              x1: n,
                              y1: m + (b[h].margin + F),
                              x2: k,
                  ...
                  if (a && 0 < a.length)
                      for (h = 0; h < a.length; h++) {
                          ...
                          if (c && 0 < c.length)
                              for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n = 0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - W : n);
                          if (b && 0 < b.length)
                              for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x1, n = k -
                                  W);
                          a[h].lineCoordinates = {
                              x1: k - R,
                              y1: m,
                  ...
                  if (d && 0 < d.length)
                      for (h = 0; h < d.length; h++) {
                          ...
                          g = c && 0 < c.length ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - T > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2 - T) : f.y2 > l.height - Math.max(K, 10) ? l.height - Math.max(K, 10) : f.y2;
                          if (c && 0 < c.length)
                              for (K = 0; K < c.length; K++) c[K] && c[K].labelAutoFit && (k = 0 > c[K].labelAngle ? Math.max(k, x) : 0 === c[K].labelAngle ? Math.max(k, x / 2) : k, n =
                                  0 > c[K].labelAngle || 0 === c[K].labelAngle ? k - U : n);
                          if (b && 0 < b.length)
                              for (K = 0; K < b.length; K++) b[K] && b[K].labelAutoFit && (k = b[K].lineCoordinates.x2, n = k - U);
                          d[h].lineCoordinates = {
                              x1: k + S,
                              y1: m,
                              x2: k + S,
                  ...
                  if (0 < v) {
                      ...
                      if (c && 0 < c.length)
                          for (h = 0; h < c.length; h++) O = E[v - 1][h] === E[v][h] ? !0 : !1;
                      else O = !0;
                      if (b && 0 < b.length)
                          for (h = 0; h < b.length; h++) M = u[v - 1][h] === u[v][h] ? !0 : !1;
                      else M = !0
                  }
                  if (t && I && O && M) break;
                  v++
      ...
      D.render = function(a, d, c, b, e) {
          ...
          e.clip();
          if (a && 0 < a.length)
              for (m = 0; m < k.length; m++) k[m].renderStripLinesOfThicknessType("value");
          if (d && 0 < d.length)
          ...
          e.restore();
          if (a && 0 < a.length)
              for (m = 0; m < a.length; m++) a[m].renderGrid(), t && (a[m].createMask(), a[m].renderBreaksBackground());
          if (d && 0 < d.length)
              for (m = 0; m < d.length; m++) d[m].renderGrid(), t && (d[m].createMask(), d[m].renderBreaksBackground());
          if (c && 0 < c.length)
              for (m = 0; m < c.length; m++) c[m].renderGrid(), t && (c[m].createMask(), c[m].renderBreaksBackground());
          if (b && 0 < b.length)
              for (m = 0; m < b.length; m++) b[m].renderGrid(), t && (b[m].createMask(), b[m].renderBreaksBackground());
          if (a && 0 < a.length)
      ...
      D.prototype.renderLabelsTicksAndTitle = function() {
          ...
          if ("bottom" === this._position) {
              ...
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                  for (g = 0; g < a._labels.length; g++)
                      if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position),
                              a.tickThickness)) {
              ...
              "inside" === this.tickPlacement && this.chart.addEventListener("dataAnimationEnd", function() {
                  for (g = 0; g < a._labels.length; g++)
                      if (q = a._labels[g], !(q.position < a.viewportMinimum || q.position > a.viewportMaximum) && (p = a.getPixelCoordinatesOnAxis(q.position), a.tickThickness)) {
                          a.ctx.lineWidth = a.tickThickness;
                          a.ctx.strokeStyle = a.tickColor;
                          var b = 1 === a.ctx.lineWidth % 2 ? (p.x << 0) + 0.5 : p.x << 0;
                          a.ctx.save();
          ...
          if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function() {
              ...
              for (g = 0; g < this._labels.length; g++) q = this._labels[g], q.position < this.viewportMinimum || (q.position > this.viewportMaximum || d && 0 !== f++ % 2 && this.labelAutoFit) || q.textBlock.render(!0)
      };
      ...
      D.prototype.renderStripLinesOfThicknessType = function(a) {
          if (this.stripLines && 0 < this.stripLines.length && a) {
              ...
              for (b = 0; b < this._stripLineLabels.length; b++)
                  if (g = this.stripLines[b], c = this._stripLineLabels[b], !(c.position < this.viewportMinimum || c.position > this.viewportMaximum || isNaN(this.range))) {
                      a = this.getPixelCoordinatesOnAxis(c.position);
                      if ("outside" === c.stripLine.labelPlacement)
                          if (g && (this.ctx.strokeStyle = g.color, "pixel" === g._thicknessType && (this.ctx.lineWidth =
                              ...
                              (r = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, this.ctx.beginPath(), this.ctx.moveTo(r, a.y << 0), this.ctx.lineTo(r, a.y - this.tickLength << 0), this.ctx.stroke(), 0 === this.labelAngle ? (a.x -= c.textBlock.width / 2, a.y -= this.tickLength + c.textBlock.height) : (a.x += (c.textBlock.height - this.tickLength - this.labelFontSize / 2) * Math.sin(Math.PI / 180 * this.labelAngle) - (0 < this.labelAngle ? c.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) : 0), a.y -= this.tickLength + (c.textBlock.height * Math.cos(Math.PI / 180 * this.labelAngle) +
                                  ...
                                  180 * this.labelAngle), a.x = 0 < this.labelAngle ? a.x + (c.textBlock.height - c.textBlock.fontSize / 2 - 5) * Math.sin(Math.PI / 180 * this.labelAngle) + this.tickLength : a.x + this.tickLength + 5));
              ...
              if (k)
                  for (k = !1, b = 0; b < l.length; b++) c = l[b], c.stripLine.showOnTop ? k || (k = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
          ...
          if ("bottom" === this._position || "top" === this._position) {
              if (this.lineThickness) {
                  ...
                  if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                      if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                          ...
                          for (var m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(e,
              ...
              if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                  if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + c;
                      ...
                      for (m = this.scaleBreaks.firstBreakIndex; m <= this.scaleBreaks.lastBreakIndex; m++) d.moveTo(k, e), d.lineTo(k, this.scaleBreaks._appliedBreaks[m].startPixel + b), e = this.scaleBreaks._appliedBreaks[m].endPixel + c;
      ...
      U.prototype.render = function(a) {
          if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
              ...
              if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                  if (b = 1 === q % 2 ? (b.x << 0) + 0.5 : b.x << 0, k = 1 === q % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1,
                          m = this.chart.plotArea.y2 + q / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, m = this.chart.plotArea.y1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
                          x1: b - q / 2,
                          y1: e,
                          x2: k + q / 2,
                          y2: m
                      }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, m), this.ctx.lineTo(k, m), this.ctx.lineTo(k, e);
                  ...
                  if (e = 1 === q % 2 ? (e.y << 0) + 0.5 : e.y <<
                      0, m = 1 === q % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, k = this.chart.plotArea.x2 + q / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, k = this.chart.plotArea.x1 - q / 2 + 0.5 << 0, a *= -1), this.bounds = {
                          ...
                          x2: k,
                          y2: m + q / 2
                      }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(k, e), this.ctx.lineTo(k, m), this.ctx.lineTo(b, m);
                  else if ("wavy" === this.type) {
                  l = b;
                  g = e;
                  f = 0.5;
      ...
      ba.prototype.showAt = function(a) {
          ...
          if ("xySwapped" === d.plotInfo.axisPlacement)
              ...
              for (b = 0; b <
                  d.axisY2.length; b++) this.parent === d.axisY2[b] && (d.axisY2[b]._crosshairValue = a >= d.axisY2[b].viewportMinimum && a <= d.axisY2[b].viewportMaximum ? a : null);
              ...
              if ("right" === this.parent._position)
                  for (b = 0; b < d.axisX2.length; b++) this.parent === d.axisX2[b] && (d.axisX2[b]._crosshairValue = a >= d.axisX2[b].viewportMinimum && a <= d.axisX2[b].viewportMaximum ?
                      a : null)
              ...
              for (b = 0; b < d.axisY.length; b++) this.parent === d.axisY[b] && (d.axisY[b]._crosshairValue =
      ...
      ba.prototype.render = function(a, d, c) {
          ...
          if (this.snapToDataPoint) {
              ...
              if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                  var v = null;
                  if ("bottom" === this.parent._position ||
                      "top" === this.parent._position) t = this.parent.dataSeries[0].axisX.convertPixelToValue({
                      y: d
                  });
                  ...
                  if ("rangeBar" === r[0].dataSeries.type || "error" === r[0].dataSeries.type)
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(r[w].dataPoint.y[0])), u = 0, t = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (var x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                          else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
                  else if ("stackedBar" === r[0].dataSeries.type)
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)),
                              z = u = 0, t = w = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                      ...
                      for (var v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), E = z = u = 0, t = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u =
                                  Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                          else z += r[t].dataPoint.y, E = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, E = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[E]), u = Math.abs(a - this.parent.convertValueToPixel(E)), u < v && (v = u, w = t);
                  else
                      for (v = Math.abs(a - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = w = u = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y[x])),
                                  u < v && (v = u, w = t);
                          else u = Math.abs(a - this.parent.convertValueToPixel(r[t].dataPoint.y)), u < v && (v = u, w = t);
                  x = r[w];
                  if ("bottom" === this.parent._position || "top" === this.parent._position) {
                      ...
                      if (this.parent.labels)
                          for (r = Math.ceil(this.parent.interval), t = 0; t < this.parent.viewportMaximum; t += r)
                              if (this.parent.labels[t]) E = !0;
                              else {
                                  E = !1;
                                  break
                              } if (E) {
                          if ("axisX" === this.parent.type)
                              for (t = this.parent.convertPixelToValue({
                                      y: d
                                  }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index && (g.text = this.labelFormatter ? this.labelFormatter({
                                  chart: this.chart,
                                  axis: this.parent.options,
                                  crosshair: this.options,
                                  value: x.dataPoint.x
                  ...
                  if ("rangeColumn" === r[0].dataSeries.type || "rangeArea" === r[0].dataSeries.type ||
                      "error" === r[0].dataSeries.type || "rangeSplineArea" === r[0].dataSeries.type || "candlestick" === r[0].dataSeries.type || "ohlc" === r[0].dataSeries.type || "boxAndWhisker" === r[0].dataSeries.type)
                      for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y[0])), t = u = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                          else u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y)),
                              u < v && (v = u, w = t);
                  else if ("stackedColumn" === r[0].dataSeries.type || "stackedArea" === r[0].dataSeries.type)
                      for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = z = u = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                          else z += r[t].dataPoint.y, u = Math.abs(d - this.parent.convertValueToPixel(z)), u < v && (v = u, w = t);
                  else if ("stackedColumn100" === r[0].dataSeries.type || "stackedArea100" ===
                      r[0].dataSeries.type)
                      for (v = Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = E = z = u = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                          else z += r[t].dataPoint.y, E = r[t].dataPoint.x.getTime ? r[t].dataPoint.x.getTime() : r[t].dataPoint.x, E = 100 * (z / r[t].dataSeries.plotUnit.dataPointYSums[E]), u = Math.abs(d - this.parent.convertValueToPixel(E)), u < v && (v = u, w = t);
                  else
                      for (v =
                          Math.abs(d - this.parent.convertValueToPixel(r[0].dataPoint.y)), t = u = 0; t < r.length; t++)
                          if (r[t].dataPoint.y && r[t].dataPoint.y.length)
                              for (x = 0; x < r[t].dataPoint.y.length; x++) u = Math.abs(d - this.parent.convertValueToPixel(r[t].dataPoint.y[x])), u < v && (v = u, w = t);
                  ...
                  if ("left" === this.parent._position || "right" === this.parent._position) {
                      ...
                      if (this.parent.labels)
                          ...
                          if ("axisX" === this.parent.type)
                              for (t = this.parent.convertPixelToValue({
                                      y: d
                                  }), v = null, w = 0; w < this.parent.dataSeries.length; w++)(v = this.parent.dataSeries[w].getDataPointAtX(t, !0)) && 0 <= v.index &&
                                  (g.text = this.labelFormatter ? this.labelFormatter({
                                      chart: this.chart,
                                      axis: this.parent.options,
                                      crosshair: this.options,
          ...
          if (!this.chart.disableToolTip) {
              ...
              if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                          ...
                          for (var l = 0; l < this.chart.axisX.length; l++) {
                              for (var k =
                                      this.chart.axisX[l].convertPixelToValue({
                                          y: d
                                      }), g = null, b = 0; b < this.chart.axisX[l].dataSeries.length; b++)(g = this.chart.axisX[l].dataSeries[b].getDataPointAtX(k, c)) && 0 <= g.index && (g.dataSeries = this.chart.axisX[l].dataSeries[b], null !== g.dataPoint.y && m.push(g));
                              g = null
                          }
                  ...
                  if (g = this.chart.getDataPointAtXY(a, d, c)) this.currentDataPointIndex = g.dataPointIndex, this.currentSeriesIndex =
                      ...
                      if (g = Ya(a, d, this.chart._eventManager.ghostCtx), 0 < g && "undefined" !== typeof this.chart._eventManager.objectMap[g]) {
